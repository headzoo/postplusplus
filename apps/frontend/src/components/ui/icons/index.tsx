...
export const NotificationIcon: FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const MagicWandIcon: FC<IconProps> = ({
  ...
  >
    ...
    />
    <path
      d="M13.75 2.25L12.25 3.75"
      stroke="currentColor"
      strokeWidth="1.2"
      strokeLinecap="round"
    />
    <path
      d="M13.75 6.75L12.25 5.25"
      stroke="currentColor"
      strokeWidth="1.2"
      strokeLinecap="round"
    />
...
// Sparkle / AI assistant icon (filled wand + stars)
export const SparkleIcon: FC<IconProps> = ({
  size = 16,
  className,
  ...props
}) => (
